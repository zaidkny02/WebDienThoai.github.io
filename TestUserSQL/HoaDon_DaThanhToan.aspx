<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false"  AutoEventWireup="true" CodeBehind="HoaDon_DaThanhToan.aspx.cs" Inherits="TestUserSQL.HoaDon_DaThanhToan" %>
            ...
            <tr>
               <td style="width:40%; " class="classtd">
                <table class="input_table">
                    <tr>
                        <td>SĐT</td>
                        <td><asp:TextBox ID="txtSDT" runat="server"  Enabled="false"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Địa chỉ</td>
                    ...
                    <tr>
                        <td>Người nhận</td>
                        <td><asp:TextBox ID="txtNguoiNhan" runat="server"  Enabled="false"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Phụ phí</td>
                    ...
                    <tr>
                        <td>Ghi chú</td>
                        <td><asp:TextBox ID="txtGhiChu" runat="server"  Enabled="false"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:center">
                          ...
                          <!--  <asp:Button ID="delBtn" runat="server" Text="Hủy" OnClick="delBtn_Click" OnClientClick="return confirm('Bạn có muốn hủy đơn hàng này?');" /> -->
                            <asp:Button ID="khoiphucBtn" runat="server" Text="Khôi phục" OnClick="khoiphucBtn_Click" OnClientClick="return confirm('Xác nhận khôi phục đơn hàng?');" />
                            <asp:Button ID="trahangBtn" runat="server" Text="Trả hàng" OnClick="trahangBtn_Click" OnClientClick="return confirm('Xác nhận đơn hàng được trả lại?');" />
                            <asp:Button ID="xacnhantrahangBtn" runat="server" Text="Xác nhận" OnClick="xacnhantrahangBtn_Click" OnClientClick="return confirm('Xác nhận yêu cầu trả lại hàng?');" />
                            <asp:Button ID="tuchoitrahangBtn" runat="server" Text="Hủy yêu cầu" OnClick="tuchoitrahangBtn_Click" OnClientClick="return confirm('Xác nhận hủy yêu cầu trả lại hàng?');" />
               ...
               <td style="width:60%;  vertical-align:bottom;  " class="classtd" >
                   ...
                   <asp:GridView style="display:none;" ID="grvChiTiet" runat="server"  CssClass="gridview" DataKeyNames="PK_iCT_HoaDonID" AutoGenerateColumns="false"
                    ...
                    <div class="timkiem" style="text-align:right;  ">
                        <asp:Label ID="Label1" Visible="false" runat="server" Text="Chế độ xem"></asp:Label>
                        <asp:DropDownList ID="ddlChedoxem"   AutoPostBack="true" OnSelectedIndexChanged="ddlChedoxem_SelectedIndexChanged" runat="server">
                            <asp:ListItem Value="0" Text="Đã thanh toán"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Trả hàng"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Yêu cầu trả hàng"></asp:ListItem>
                        </asp:DropDownList>
                        <br />
                        ...
                        <br />
                        <p><asp:Label ID="Label2" runat="server" Text="Từ ngày"></asp:Label><asp:TextBox ID="txtTuNgay" runat="server" Type="Date" AutoPostBack="true" OnTextChanged="txtTuNgay_TextChanged" /></p>
                        <p><asp:Label ID="Label3" runat="server" Text="Đến ngày"></asp:Label><asp:TextBox Type="Date" ID="txtDenNgay" runat="server" AutoPostBack="true" OnTextChanged="txtDenNgay_TextChanged" ></asp:TextBox></p>
                    </div>
               </td>
            </tr>
        </table>
                ...
                <asp:gridview runat="server" ID="grvHoaDon"   CssClass="gridview" DataKeyNames="PK_iMahoadon" AutoGenerateColumns="false" PageSize="5" OnPageIndexChanging="grvHoaDon_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Trạng thái" Visible="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="8%"  >
                            <ItemTemplate>
